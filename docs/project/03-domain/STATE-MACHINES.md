...
This document is a planning stub for **State Machines**. It exists to establish the required documentation baseline before deeper monorepo implementation proceeds.
